...
import org.infinispan.quickstart.clusteredcache.loader.TestConfigBuilder;
...
public class Node {
   ...
   public void run() throws IOException, InterruptedException {
      ...
      final Cache<Integer, String> cache = cacheManager.getCache(cacheName);
    ...
    * @param cache
    */
   private void printCacheContents(Cache<Integer, String> cache) {
      System.out.printf("Cache contents on node %s\n", cache.getAdvancedCache().getRpcManager().getAddress());

      ArrayList<Map.Entry<Integer, String>> entries = new ArrayList<Map.Entry<Integer, String>>(cache.entrySet());
   ...
   private EmbeddedCacheManager createCacheManagerProgrammatically() {
      ...
      DefaultCacheManager cacheManager = new DefaultCacheManager(
            ...
            new ConfigurationBuilder()
                  ...
                  .persistence()
                  .addStore(TestConfigBuilder.class)
